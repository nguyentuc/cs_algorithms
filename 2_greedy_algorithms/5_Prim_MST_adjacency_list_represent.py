...
class Heap():
    ...
    # A standard fuction to heapify at given idx
    # this fuction also updates posisition of nodes when they swaped
    ...
    def minHeapify(self, idx):
        ...
        # the nodes to be swaped in min heap if idx is not smallest
        if smallest != idx:
            # swap positions
    ...
    def decreaseKey(self, v, dist):
        # Get the index of v in min heap arry
        i = self.pos[v]
        # Get the node and update its dist value
        self.array[i][1] = dist

        # Travel up shile the complete tree is not heapify. This is a o(logn) lop
